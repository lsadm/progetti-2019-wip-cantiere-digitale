...
class RegistrazioneFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnCrea.setOnClickListener {
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener { task ->
                ...
                if (task.isSuccessful) {
                    ...
                    val datiUtente = Utente(
                        ...
                        SpinnerScelta.getSelectedItem().toString(),
                        s
                    )
            ...
            getActivity()!!.getSupportFragmentManager().beginTransaction().remove(this).commit()//rimuove il fragment dallo stack per evitare doppie registrazioni
        }
    }
}
